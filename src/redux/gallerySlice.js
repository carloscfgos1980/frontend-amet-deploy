...
export const getDataAsync = createAsyncThunk(
    ...
    async () => {
        const response = await fetch('https://ma3tbancked.azurewebsites.net/painting');
        if (response.ok) {
...
export const paintReservedAsync = createAsyncThunk(
    ...
    async (payload) => {
        const resp = await fetch(`https://ma3tbancked.azurewebsites.net/update/${payload.id}`, {
            method: 'PATCH',
            headers: {
...
export const addReservedPaintAsync = createAsyncThunk(
    ...
    async (payload) => {
        const resp = await fetch('https://ma3tbancked.azurewebsites.net/reserved', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
export const addCustomerAsync = createAsyncThunk(
    ...
    async (payload) => {
        const resp = await fetch('https://ma3tbancked.azurewebsites.net/customer', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
export const addFanAsync = createAsyncThunk(
    'gallery/addFanAsync',
    async (payload) => {
        const resp = await fetch('https://ma3tbancked.azurewebsites.net/fan', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
export const deleteReservedAsync = createAsyncThunk(
    ...
    async (payload) => {
        const resp = await fetch(`https://ma3tbancked.azurewebsites.net/delete-paintingReserved/${payload.id}`, {
            method: 'DELETE',
        });
